<template>
    <div class="box">
        <p class="title">病种统计分布 > 各病种人群属性分布</p>
        <div class="head">
            <div class="head-top"><p>各病种人群属性分布</p></div>
            <div class="main">
                <ul class="uls">
    ...
    export default {
        ...
        methods: {
            ...
            defaultData () {
                ...
                $.ajax({
                    type: "get",
                    url: localhost + "backstage/statistics/distribute/11",
                    dataType: "json",
                    data: {
