                ...
                <div class="layer-cent">
                    <ul class="uls">
                        ...
                        <li>
                            ...
                            <p>{{adviceTime}}</p>
                            <p>
                                <el-select @change="changeValue" v-model="detailsStatus" placeholder="请选择">
                                    <el-option
                                        v-for="item in options"
                                        :key="item.value"
                                        :label="item.label"
...
<script>
    ...
    export default{
        ...
        methods: {
            sendClick () { // 发送
                if(this.detailsStatus == '未处理') {
                    this.status = '0'
                } else if (this.detailsStatus == '处理中') {
                    this.status = '1'
                } else if (this.detailsStatus == '已处理') {
                    this.status = '2'
                }
                        ...
                        if (data.code == '200') {
                            ...
                            historyRecords.forEach((item) => {
                                if (item.cFrom == '0') {
                                    ...
                                    obj.name = 'left'
                                    obj.imgUrl = 'http://doctor.dlcaring.com/logoing.png'
                                } else if(item.cFrom == '1') {
                                    let obj = new Object(item)
                                    obj.name = 'right'
                                    obj.imgUrl = 'http://doctor.dlcaring.com/dialog.png'
                                }
                            })
